...
;(function ($, window, document, undefined) {
    ...
    Shutter.prototype = {
        ...
        toggleMove: function (command, index) {
            ...
            // 切换标识点
            this.pagination(this.opts.paginationEl,index);
            // 切换图片
        ...
        pagination:function (className, index) {
            $(className).find('span').eq(index).addClass('active').siblings().removeClass('active');
        },
        paginationClick:function(){
            var self = this;
            $(this.opts.paginationEl).find('span').click(function () {
                var index = $(this).index();
                self.toggleMove('', index)
            })
        },
        inital: function (elem) {
            ...
            this.$shutterNav = this.$shutter.find('.shutter-pagination span');
