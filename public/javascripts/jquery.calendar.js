                   ...
                   if(date==targetdate){
                	   if(!opts.settingdata[i].currPrice){
                		   pricetext="<span class='price' data-childstock='"+opts.settingdata[i].childStock+
                               "' data-stock='"+opts.settingdata[i].leftSum+"' data-childPrice='"+
                               opts.settingdata[i].childPrice+"'>" +
                               "<strong>暂无价格</strong></span>";
                	   }else{
                		   pricetext="<span class='price' data-childstock='"+opts.settingdata[i].childStock+
                               "' data-stock='"+opts.settingdata[i].leftSum+"' data-childPrice='"+opts.settingdata[i].childPrice+"'>" +
                               "<em>￥</em><strong>"+opts.settingdata[i].currPrice+"</strong></span>";
                	   }
